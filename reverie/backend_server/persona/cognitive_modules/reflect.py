...
def reflect(persona):
    ...
    if reflection_trigger(persona):
        run_reflect(persona)
        # lg: generate_focal_points()
        # lg: run_gpt_prompt_focal_pt()
        # lg: new_retrieve()
        # lg: generate_insights_and_evidence()
        # lg: run_gpt_prompt_insight_and_guidance()
        # lg: generate_action_event_triple()
        # lg: run_gpt_prompt_event_triple()
        # lg: generate_poig_score()
        # lg: run_gpt_prompt_event_poignancy()
        # lg: run_gpt_prompt_chat_poignancy()
        # lg: get_embedding()
    ...
    if persona.scratch.chatting_end_time:
        ...
        if (
            ...
            memo_thought = generate_memo_on_convo(persona, all_utt)  ###
            # lg: run_gpt_prompt_memo_on_convo()
